...
export const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px]  md: font-extrabold max-w-xl mt-4'>Discover Your Perfect Gateway Destination</h1>
